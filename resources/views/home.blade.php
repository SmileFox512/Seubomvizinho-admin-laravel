...
<div class="q-container">
    <div class="row">
        ...
        @if (Auth::user()->role == 1)
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div id="restaurants" class="pt-5 q-info-box q-color-purple-bkg hover-zoom-effect q-radius">
                    <div class="icon">
                        <i class='material-icons' style="justify-content: center;align-items: center;display: flex;height: 100%;">
                            <img class="mt-15 img-thumbnail mx-auto" style="display: inline-block; background-color:transparent; border:none; height: 45px; width: 45px;background-repeat: round;" src="{{url('/images/carrinho.png')}}">
</i>
                    </div>
                    <!-- <div class="icon">
                        <i class="material-icons">person_outline</i>
                            ...
                            @foreach($iorders as $key => $data)
                                @if ($data->send == 1)
                                    <tr id="tr{{$data->id}}">
                                        ...
                                        <td>{{(new DateTime($data->updated_at))->format('d/m/Y')}}</td>
                                    </tr>
                                @endif
