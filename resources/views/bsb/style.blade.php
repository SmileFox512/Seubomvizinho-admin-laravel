...
<style>
    ...
    .q-info-box.hover-zoom-effect .icon {
        overflow: hidden; }
    .q-info-box.hover-zoom-effect .icon i,.q-info-box.hover-zoom-effect .icon div {
        -moz-transition: all 0.3s ease;
        -o-transition: all 0.3s ease;
        -webkit-transition: all 0.3s ease;
        transition: all 0.3s ease; }

    .q-info-box.hover-zoom-effect:hover .icon i, .q-info-box.hover-zoom-effect:hover .icon div {
        opacity: 0.4;
