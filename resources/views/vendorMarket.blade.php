...
@section('content')
    ...
    <div class="q-card q-radius q-container">
        ...
        <ul class="nav nav-tabs tab-nav-right" role="tablist">
            <li role="presentation" class="active"><a href="#home" data-toggle="tab"><h4>{{$lang->get(47)}}</h4></a></li> {{--Market--}}
...
<script type="text/javascript">
    ...
    let arrCityInit = "{{$data->city}}".split(',');
    let arrCitySelected = [];
    ...
    async function editItem(id, name, visible, imageid, ifile, desc,
        ...
        arrCityInit.forEach(function (item) {
            console.log("arrCityInit: " +item);
            $('#city').multiSelect('select', item);
        });
    }
