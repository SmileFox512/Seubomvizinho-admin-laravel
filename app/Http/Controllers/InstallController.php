...
class InstallController extends Controller
{
    public static function update()
    {
        ...
        if (count(DB::table('settings')->where("param", 'payMobEnable')->get()) == 0)
            DB::table('settings')->insert(['param' => 'payMobEnable', 'value' => 'true', 'created_at' => new \DateTime(), 'updated_at' => new \DateTime(),]);
        ...
        if (!Schema::hasColumn('restaurants', 'city')) {
            ...
            //DB::statement("ALTER TABLE restaurants ADD COLUMN city TEXT DEFAULT ''");
